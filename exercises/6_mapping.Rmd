...
covid_county_wide$location <- tolower(covid_county_wide$location) %>% 
                                        stringr::str_replace("_",",") 

colorfunction <- stevens.pinkgreen # bivariate color function
nbins <- 3

breaks.cases <- classIntervals(covid_county_wide$Daily_Cases, 
                               n=nbins,
                               style='equal') # equal breaks across range of data

breaks.deaths <- classIntervals(covid_county_wide$Daily_Deaths,
                               n=nbins,
                               style='equal') # equal breaks across range of data
